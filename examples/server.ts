...
class Client {
  ...
  constructor(conn: any, peer: string) {
  ...
  socket.on('message', (msg: any, rinfo: { address: any; port: any; }) => {
    ...
    if (!client) {
      ...
      try {
        ...
        console.error('accept failed:', (e as Error).message);
        return;
      }
    }
      ...
      while (true) {
        ...
        if (event.eventType === 'headers') {
          ...
          try {
            ...
            console.error('send response error:', (e as Error).message);
          }
        }
        ...
        if (event.eventType === 'finished') {
          ...
          try {
            ...
            if (!((e as Error).message).includes('Done')) {
              console.error('send body error:', (e as Error).message);
            }
          }
        }
      }
